...
// $modifier = 'anonymous'; // commented out by hayamizu
$modifier = 'hayamizu'; // added by hayamizu

// Site admin's Web page (CHANGE THIS)
// $modifierlink = 'http://pukiwiki.example.com/'; // commented out by hayamizu
$modifierlink = 'http://www.net.ee.kansai-u.ac.jp/~hayamizu'; // added by hayamizu 

// Default page name
$defaultpage  = 'Yusaku Hayamizu';     // Top / Default page
/* $defaultpage  = 'FrontPage';     // Top / Default page */ // commented out by hayamizu
...
// Default: always fail
// $adminpass = '{x-php-md5}!'; // commented out by hayamizu
$adminpass = '{x-php-md5}' . md5('sakusaku'); // added by hayamizu
