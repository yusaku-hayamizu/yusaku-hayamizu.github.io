...
// Set site identities
$_IMAGE['skin']['logo']     = 'pukiwiki.png'; // commented out by hayamizu
...
<div id="header">
 <a href="<?php echo $link['top'] ?>"><img id="logo" src="<?php echo IMAGE_DIR . $image['logo'] ?>" width="0" height="0" alt="[PukiWiki]" title="[PukiWiki]" /></a>
...
<div id="footer">
 Copyright &copy; 2016-2019 <a href=http://www.net.ee.kansai-u.ac.jp/~hayamizu> Yusaku Hayamizu </a>. All Right Reserved.
 <!-- commented out by hayamizu
